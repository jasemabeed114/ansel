...
    if(!message.member.roles.some(r=>["Z DEV", "Moderator"].includes(r.name)) )
...
    if(!message.member.roles.some(r=>["Z DEV"].includes(r.name)) )

      return message.reply("Hanya Owner BOT!");
